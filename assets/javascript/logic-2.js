...
var coinButtonArray = ["BTC", "LTC", "VTC", "NEO"];
...
function createButtons() {
    ...
    for (var i = 0; i < coinButtonArray.length; i++) {
        var queryURL = "https://rest.coinapi.io/v1/exchangerate/" + coinButtonArray[i] + "?apikey=C3F818BB-21EF-425E-B53C-B069172C81CD";
        ...
        $.ajax({
            ...
            .then(function (response) {
                ...
                var coinPrice = response.rates[0].rate;
                var nameId = response.rates[0].asset_id_quote
